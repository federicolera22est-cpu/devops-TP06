...
![CI/CD Pipeline](https://github.com/federicolera22est-cpu/devops-TP06/actions/workflows/cicd.yml/badge.svg)
...
| deploy     | solo main          | SSH al servidor, docker compose up     |
